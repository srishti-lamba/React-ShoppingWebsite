...
const Reviews = ({showLogin, toggleLogin}) => {
    ...
    function submitReviewSearch() {
        ...
        // Get Reviews
        const url = "http://localhost/phpScripts/getReviews.php";
    ...
    function submitReviewWrite(event) {
        ...
        // Create post request
        const url = "http://localhost/phpScripts/writeReview.php"
        let fdata = new FormData();
    ...
    function setupDatabase() {
        ...
        fileArray.forEach((fileName) => {
            let url = "http://localhost/phpScripts/" + fileName
            let fdata = new FormData();
            axios.post(url, fdata)
            .catch((err) => {
                console.log(err)
    ...
    function getItemNames() {
        const url = "http://localhost/phpScripts/getProducts.php"
        axios.get(url)
        .then(res => {
